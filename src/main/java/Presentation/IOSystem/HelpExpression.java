...
public class HelpExpression implements AbstractExpression
{
    ...
    final private String design_pattern_zh_CN = "design_pattern abstract_factory\t抽象工厂模式\t\t"+
    ...
    final private String design_pattern_zh_TW = "design_pattern abstract_factory\t抽象工廠模式\t\t"+
    ...
    final private String design_pattern_en = "design_pattern abstract_factory\t\t\t"+
